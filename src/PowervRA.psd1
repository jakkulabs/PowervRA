...
FunctionsToExport = @('Connect-vRAServer','Disconnect-vRAServer','Get-vRAAPIVersion','Get-vRABlockDevice','Get-vRABlueprint','Get-vRACatalogItem','Get-vRACloudAccount','Get-vRACloudZone','Get-vRACodeStreamExecution','Get-vRACodeStreamPipeline','Get-vRACodeStreamVariable','Get-vRAContentSource','Get-vRADeployment','Get-vRAFabricAWSVolumeType','Get-vRAFabricAzureStorageAccount','Get-vRAFabricCompute','Get-vRAFabricImage','Get-vRAFabricNetwork','Get-vRAFlavorProfile','Get-vRAImageProfile','Get-vRAMachine','Get-vRAMachineDisk','Get-vRANetworkProfile','Get-vRAOnboardingDeployment','Get-vRAOnboardingPlan','Get-vRAOnboardingPlanExecution','Get-vRAOnboardingResource','Get-vRAProject','Get-vRARegionEnumerationvSphere','Get-vRARequest','Get-vRAvSphereFabricDatastore','Get-vRAFabricNetwork','Get-vRAvSphereFabricStoragePolicy','Invoke-vRAOnboardingPlan','Invoke-vRARestMethod','New-vRACloudAccountAzure','New-vRACloudAccountGCP','New-vRACloudAccountvSphere','New-vRAMachineAttachedDisk','New-vRAOnboardingDeployment','New-vRAOnboardingPlan','New-vRAOnboardingResource','New-vRAProject','New-vRAVirtualDisk','Remove-vRACloudAccount','Remove-vRACodeStreamExecution','Remove-vRACodeStreamVariable','Remove-vRAOnboardingDeployment','Remove-vRAOnboardingPlan','Remove-vRAOnboardingResource','Remove-vRAProject','Resize-vRAMachine','Restart-vRAMachine','Restart-vRAMachineGuestOS','Start-vRAMachine','Stop-vRAMachine','Stop-vRAMachineGuestOS','Suspend-vRAMachine','Update-vRACodeStreamVariable')
