...
FunctionsToExport = @('Get-vRACodeStreamExecution','Get-vRACodeStreamPipeline','Get-vRACodeStreamVariable','Remove-vRACodeStreamExecution','Remove-vRACodeStreamVariable','Update-vRACodeStreamVariable','Connect-vRAServer','Disconnect-vRAServer','Get-vRAAPIVersion','Get-vRABlockDevice','Get-vRACloudAccount','Get-vRACloudZone','Get-vRAMachine','Get-vRAMachineDisk','Get-vRAProject','Get-vRARegionEnumerationvSphere','Get-vRARequest','New-vRACloudAccountAzure','New-vRACloudAccountGCP','New-vRACloudAccountvSphere','New-vRAMachineAttachedDisk','New-vRAProject','New-vRAVirtualDisk','Remove-vRACloudAccount','Remove-vRAProject','Resize-vRAMachine','Resize-vRAVirtualDisk','Restart-vRAMachine','Restart-vRAMachineGuestOS','Start-vRAMachine','Stop-vRAMachine','Stop-vRAMachineGuestOS','Suspend-vRAMachine','Invoke-vRARestMethod','Get-vRAOnboardingDeployment','Get-vRAOnboardingPlan','Get-vRAOnboardingPlanExecution','Get-vRAOnboardingResource','Invoke-vRAOnboardingPlan','New-vRAOnboardingDeployment','New-vRAOnboardingPlan','New-vRAOnboardingResource','Remove-vRAOnboardingDeployment','Remove-vRAOnboardingPlan','Remove-vRAOnboardingResource')
