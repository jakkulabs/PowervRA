...
Task UpdateModuleManifest {
    ...
    try {
        ...
        $NestedModules = $PublicFunctions | ForEach-Object {$_.FullName.Substring($_.FullName.LastIndexOf($ModuleRoot)+$ModuleRoot.Length).Trim("\")}
        $ScriptsToProcess = $PrivateFunctions | ForEach-Object {$_.FullName.Substring($_.FullName.LastIndexOf($ModuleRoot)+$ModuleRoot.Length).Trim("\")}
